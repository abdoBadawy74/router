    ...
    return (
        <div className="overflow-hidden">
            ...
            <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden mb-32">
                ...
                <div className="absolute bottom-20 right-20 w-96 h-96 bg-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float" style={{ animationDelay: '1s' }}></div>
                <div className="absolute top-40 right-1/4 w-64 h-64 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float" style={{ animationDelay: '2s' }}></div>

                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-16">
                    <div className="text-center animate-fade-in-up">
                        <div className="inline-block mb-4 px-6 p-2 glass-dark rounded-full">
                            <span className="text-white text-sm font-semibold">🚀 أفضل خدمات الإنترنت في المنطقة</span>
                        </div>
                        ...
                        <p className="text-xl md:text-2xl mb-10 text-blue-100 max-w-3xl mx-auto leading-relaxed">
                            استمتع بأسرع خدمات الإنترنت والألياف الضوئية مع أحدث أجهزة الرواتر وتقنيات الجيل الجديد
                        </p>
            ...
            <section className="py-32 relative">
                <div className="px-4 sm:px-6 lg:px-8" style={{
                    ...
                    <div className="text-center mb-16 animate-fade-in-up" style={{
                        ...
                        <p className="text-xl text-gray-600">نقدم أفضل تجربة إنترنت في المنطقة</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="animate-slide-in-right">
                            <div className="inline-block mb-4 px-4 py-2 bg-purple-100 rounded-full">
                                <span className="gradient-text text-sm font-semibold">💎 عن الشركة</span>
                            </div>
                            ...
                            <p className="text-lg text-gray-600 mb-4 leading-relaxed">
                                نحن شركة رائدة في مجال تقديم خدمات الإنترنت والألياف الضوئية في المنطقة. نفخر بتقديم أفضل الحلول التقنية لعملائنا من الأفراد والشركات.
                            </p>

                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                مع خبرة تمتد لسنوات عديدة، نضمن لك الحصول على خدمة إنترنت سريعة ومستقرة مع دعم فني متواصل على مدار الساعة.
                            </p>
                        ...
                        <div className="relative animate-fade-in" style={{ padding: '20px' }}>
                            ...
                            <div className="relative glass-effect rounded-3xl p-12 shadow-2xl">
                                <div className="text-center">
                                    ...
                                    <p className="text-2xl font-bold text-gray-700 mt-6">سرعة وأداء لا مثيل له</p>
