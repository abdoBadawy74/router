...
import { UserOutlined, PhoneOutlined, MailOutlined, MessageOutlined, WhatsAppOutlined, EnvironmentOutlined } from '@ant-design/icons';
...
const Contact = () => {
    ...
    const handleWhatsApp = () => {
        const phoneNumber = '+201229890685';
    ...
    return (
        <div className="py-20 min-h-screen relative overflow-hidden">
            ...
            <div className="absolute bottom-20 left-20 w-96 h-96 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float" style={{ animationDelay: '1s' }}></div>

            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-16 animate-fade-in-up">
                    <div className="inline-block mb-4 px-4 py-2 bg-green-100 rounded-full">
                        <span className="gradient-text text-sm font-semibold">📞 اتصل بنا</span>
                    </div>
                    <h1 className="text-5xl md:text-6xl font-bold mb-6" style={{ margin: "20px 0" }}>
                ...
                <Row gutter={[32, 32]}>
                    {/* Contact Form */}
                    <Col xs={24} lg={12}>
                        <Card className="glass-effect border-0 shadow-2xl rounded-3xl animate-fade-in-up" bodyStyle={{ padding: '40px' }}>
                            ...
                            >
                                <Form.Item
                                    label={<span className="font-semibold text-gray-700">الاسم</span>}
                                    name="name"
                                ...
                                <Form.Item
                                    label={<span className="font-semibold text-gray-700">رقم الهاتف</span>}
                                    name="phone"
                                    rules={[
                                        { required: true, message: 'من فضلك أدخل رقم هاتفك' },
                                        { pattern: /^[0-9]{11}$/, message: 'رقم الهاتف يجب أن يكون 11 رقم' }
                                    ]}
                                >
                                    <Input
                                ...
                                <Form.Item
                                    label={<span className="font-semibold text-gray-700">البريد الإلكتروني</span>}
                                    name="email"
                                    rules={[
                                        { required: true, message: 'من فضلك أدخل بريدك الإلكتروني' },
                                ...
                                <Form.Item
                                    label={<span className="font-semibold text-gray-700">الرسالة</span>}
                                    name="message"
                    ...
                    <Col xs={24} lg={12}>
                        <div className="space-y-6 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                            <Card className="glass-effect border-0 shadow-2xl rounded-3xl" bodyStyle={{ padding: '40px' }}>
                                <h2 className="text-3xl font-bold mb-20 gradient-text " style={{ margin: "20px 0" }}>
                                    معلومات التواصل 📱
                                </h2>
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4 p-4 rounded-2xl hover:bg-purple-50 transition-colors" style={{ margin: "20px 0" }}>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-lg" dir="ltr">+201229890685</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 p-4 rounded-2xl hover:bg-purple-50 transition-colors" style={{ margin: "20px 0" }}>
                                        ...
                                        <div>
                                            <p className="font-bold text-gray-800 mb-1">البريد الإلكتروني</p>
                                            <p className="text-gray-600 text-lg">info@isp-company.com</p>
                                        </div>
                                    </div>
                            ...
                            {/* Map Placeholder */}
                            <Card className="glass-effect border-0 shadow-2xl rounded-3xl" bodyStyle={{ padding: '32px' }}>
                                <h3 className="text-2xl font-bold mb-6 gradient-text">موقعنا 📍</h3>
                                <div className="bg-gradient-to-br from-purple-100 via-blue-100 to-cyan-100 rounded-2xl h-64 flex items-center justify-center">
                                    <div className="text-center">
                                        ...
                                        <p className="font-bold text-xl text-gray-800 mb-2">خريطة الموقع</p>
